...
namespace Application.Services
{
    ...
    public sealed class IncidentHistoryService(ILogger<IncidentHistoryService> logger, IMapper mapper, IIncidentRepository incidentRepository, IIncidentHistoryRepository incidentHistoryRepository) : IIncidentHistoryService
    {
