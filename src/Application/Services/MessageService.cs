...
public sealed class MessageService(ILogger<MessageService> logger, IUnitOfWork unitOfWork, IMapper mapper, IMessageRepository messageRepository, IIncidentRepository incidentRepository) : IMessageService
{
